export const ChatListLoading = () => {
  return (
    <div className="space-y-2 mb-4 flex-1">
      {[...Array(6)].map((_, index) => (
        <div key={index} className="bg-gray-700/30 p-2 rounded-xl animate-pulse">
          <div className="flex items-center gap-2">
            <div className="p-2 rounded-full bg-gray-500/40">
              <div className="w-4 h-4 bg-gray-500/40 rounded-xl"></div>
            </div>
            <div className="flex-1">
              <div className="h-3 bg-gray-600/40 rounded-xl w-3/4 mb-2"></div>
              <div className="flex items-center gap-2">
